...
Project.filter<0>=dc_fifo_reset*
...
Project.filter<1>=w18_fifo_empty*
Project.filter<2>=dc_wr_en*
Project.filter<3>=internal_din*
Project.filter<4>=dc_rx*
Project.filter<5>=dc_rx_data*
Project.filter<6>=dc_bit*
Project.filter<7>=dc_fifo*
Project.filter<8>=
...
Project.unit<0>.dataChannel<107>=comm_process WAVE_DIN<31>
Project.unit<0>.dataChannel<108>=comm_process WAVE_DIN<30>
Project.unit<0>.dataChannel<109>=comm_process WAVE_DIN<29>
Project.unit<0>.dataChannel<10>=comm_process reg_data<7>
Project.unit<0>.dataChannel<110>=comm_process WAVE_DIN<28>
Project.unit<0>.dataChannel<111>=comm_process WAVE_DIN<27>
Project.unit<0>.dataChannel<112>=comm_process WAVE_DIN<26>
Project.unit<0>.dataChannel<113>=comm_process WAVE_DIN<25>
Project.unit<0>.dataChannel<114>=comm_process WAVE_DIN<24>
Project.unit<0>.dataChannel<115>=comm_process WAVE_DIN<23>
Project.unit<0>.dataChannel<116>=comm_process WAVE_DIN<22>
Project.unit<0>.dataChannel<117>=comm_process WAVE_DIN<21>
Project.unit<0>.dataChannel<118>=comm_process WAVE_DIN<20>
Project.unit<0>.dataChannel<119>=comm_process WAVE_DIN<19>
Project.unit<0>.dataChannel<11>=comm_process reg_data<6>
Project.unit<0>.dataChannel<120>=comm_process WAVE_DIN<18>
Project.unit<0>.dataChannel<121>=comm_process WAVE_DIN<17>
Project.unit<0>.dataChannel<122>=comm_process WAVE_DIN<16>
...
Project.unit<0>.dataChannel<32>=comm_process DC_FIFO_DOUT<31>
Project.unit<0>.dataChannel<33>=comm_process DC_FIFO_DOUT<30>
Project.unit<0>.dataChannel<34>=comm_process DC_FIFO_DOUT<29>
Project.unit<0>.dataChannel<35>=comm_process DC_FIFO_DOUT<28>
Project.unit<0>.dataChannel<36>=comm_process DC_FIFO_DOUT<27>
Project.unit<0>.dataChannel<37>=comm_process DC_FIFO_DOUT<26>
Project.unit<0>.dataChannel<38>=comm_process DC_FIFO_DOUT<25>
Project.unit<0>.dataChannel<39>=comm_process DC_FIFO_DOUT<24>
Project.unit<0>.dataChannel<3>=comm_process w1r8_fifo_dout<4>
Project.unit<0>.dataChannel<40>=comm_process DC_FIFO_DOUT<23>
Project.unit<0>.dataChannel<41>=comm_process DC_FIFO_DOUT<22>
Project.unit<0>.dataChannel<42>=comm_process DC_FIFO_DOUT<21>
Project.unit<0>.dataChannel<43>=comm_process DC_FIFO_DOUT<20>
Project.unit<0>.dataChannel<44>=comm_process DC_FIFO_DOUT<19>
Project.unit<0>.dataChannel<45>=comm_process DC_FIFO_DOUT<18>
Project.unit<0>.dataChannel<46>=comm_process DC_FIFO_DOUT<17>
Project.unit<0>.dataChannel<47>=comm_process DC_FIFO_DOUT<16>
Project.unit<0>.dataChannel<48>=comm_process DC_FIFO_DOUT<15>
Project.unit<0>.dataChannel<49>=comm_process DC_FIFO_DOUT<14>
Project.unit<0>.dataChannel<4>=comm_process w1r8_fifo_dout<3>
Project.unit<0>.dataChannel<50>=comm_process DC_FIFO_DOUT<13>
Project.unit<0>.dataChannel<51>=comm_process DC_FIFO_DOUT<12>
Project.unit<0>.dataChannel<52>=comm_process DC_FIFO_DOUT<11>
Project.unit<0>.dataChannel<53>=comm_process DC_FIFO_DOUT<10>
Project.unit<0>.dataChannel<54>=comm_process DC_FIFO_DOUT<9>
Project.unit<0>.dataChannel<55>=comm_process DC_FIFO_DOUT<8>
Project.unit<0>.dataChannel<56>=comm_process DC_FIFO_DOUT<7>
Project.unit<0>.dataChannel<57>=comm_process DC_FIFO_DOUT<6>
Project.unit<0>.dataChannel<58>=comm_process DC_FIFO_DOUT<5>
Project.unit<0>.dataChannel<59>=comm_process DC_FIFO_DOUT<4>
Project.unit<0>.dataChannel<5>=comm_process w1r8_fifo_dout<2>
Project.unit<0>.dataChannel<60>=comm_process DC_FIFO_DOUT<3>
Project.unit<0>.dataChannel<61>=comm_process DC_FIFO_DOUT<2>
Project.unit<0>.dataChannel<62>=comm_process DC_FIFO_DOUT<1>
Project.unit<0>.dataChannel<63>=comm_process DC_FIFO_DOUT<0>
...
Project.unit<0>.triggerChannel<1><91>=comm_process WAVE_DIN<15>
Project.unit<0>.triggerChannel<1><92>=comm_process WAVE_DIN<14>
Project.unit<0>.triggerChannel<1><93>=comm_process WAVE_DIN<13>
Project.unit<0>.triggerChannel<1><94>=comm_process WAVE_DIN<12>

...
add wave -noupdate -format Logic /demo_tb/dut/mdio
add wave -noupdate -divider {AXI4-Lite Interface}
add wave -noupdate -format Logic /demo_tb/dut/s_axi_aclk
add wave -noupdate -format Logic /demo_tb/dut/s_axi_reset_int
add wave -noupdate -format Logic /demo_tb/dut/s_axi_resetn
add wave -noupdate -format Literal -radix hexadecimal /demo_tb/dut/s_axi_araddr
add wave -noupdate -format Logic /demo_tb/dut/s_axi_arready
add wave -noupdate -format Logic /demo_tb/dut/s_axi_arvalid
add wave -noupdate -format Literal -radix hexadecimal /demo_tb/dut/s_axi_rdata
add wave -noupdate -format Logic /demo_tb/dut/s_axi_rready
add wave -noupdate -format Literal /demo_tb/dut/s_axi_rresp
add wave -noupdate -format Logic /demo_tb/dut/s_axi_rvalid
add wave -noupdate -format Literal -radix hexadecimal /demo_tb/dut/s_axi_awaddr
add wave -noupdate -format Logic /demo_tb/dut/s_axi_awready
add wave -noupdate -format Logic /demo_tb/dut/s_axi_awvalid
add wave -noupdate -format Logic /demo_tb/dut/s_axi_bready
add wave -noupdate -format Literal /demo_tb/dut/s_axi_bresp
add wave -noupdate -format Logic /demo_tb/dut/s_axi_bvalid
add wave -noupdate -format Literal -radix hexadecimal /demo_tb/dut/s_axi_wdata
add wave -noupdate -format Logic /demo_tb/dut/s_axi_wready
add wave -noupdate -format Logic /demo_tb/dut/s_axi_wvalid

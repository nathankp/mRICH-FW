...
Project.unit<0>.triggerChannel<0><0>=comm_process ETH_MODULE tx_udp_data<7>
Project.unit<0>.triggerChannel<0><10>=comm_process ETH_MODULE rx_udp_data<6>
Project.unit<0>.triggerChannel<0><11>=comm_process ETH_MODULE rx_udp_data<5>
Project.unit<0>.triggerChannel<0><12>=comm_process ETH_MODULE rx_udp_data<4>
Project.unit<0>.triggerChannel<0><13>=comm_process ETH_MODULE rx_udp_data<3>
Project.unit<0>.triggerChannel<0><14>=comm_process ETH_MODULE rx_udp_data<2>
Project.unit<0>.triggerChannel<0><15>=comm_process ETH_MODULE rx_udp_data<1>
Project.unit<0>.triggerChannel<0><16>=comm_process ETH_MODULE rx_udp_data<0>
Project.unit<0>.triggerChannel<0><17>=comm_process ETH_MODULE tx_udp_ready
Project.unit<0>.triggerChannel<0><18>=comm_process ETH_MODULE rx_udp_valid
Project.unit<0>.triggerChannel<0><19>=comm_process DC_FIFO_DOUT<31>
Project.unit<0>.triggerChannel<0><1>=comm_process ETH_MODULE tx_udp_data<6>
...
Project.unit<0>.triggerChannel<0><2>=comm_process ETH_MODULE tx_udp_data<5>
...
Project.unit<0>.triggerChannel<0><3>=comm_process ETH_MODULE tx_udp_data<4>
Project.unit<0>.triggerChannel<0><4>=comm_process ETH_MODULE tx_udp_data<3>
Project.unit<0>.triggerChannel<0><5>=comm_process ETH_MODULE tx_udp_data<2>
Project.unit<0>.triggerChannel<0><6>=comm_process ETH_MODULE tx_udp_data<1>
Project.unit<0>.triggerChannel<0><7>=comm_process ETH_MODULE tx_udp_data<0>
Project.unit<0>.triggerChannel<0><8>=comm_process ETH_MODULE tx_udp_valid
Project.unit<0>.triggerChannel<0><9>=comm_process ETH_MODULE rx_udp_data<7>
...
Project.unit<1>.clockChannel=CLK_FANOUT_1TO2 CLK_OUT1
...
Project.unit<1>.triggerChannel<0><0>=comm_process internal_tx
Project.unit<1>.triggerChannel<0><1>=comm_process internal_data_out
Project.unit<1>.triggerChannel<0><2>=comm_process SCROD_TRIG<3>
Project.unit<1>.triggerChannel<0><3>=comm_process SCROD_TRIG<2>
Project.unit<1>.triggerChannel<0><4>=comm_process SCROD_TRIG<1>
Project.unit<1>.triggerChannel<0><5>=comm_process SCROD_TRIG<0>
Project.unit<1>.triggerChannel<0><6>=comm_process wave_dout<7>
Project.unit<1>.triggerChannel<0><7>=comm_process wave_dout<6>

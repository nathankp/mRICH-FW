...
xst -ifn xst.scr
move CLK_FANOUT_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\CLK_FANOUT_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc CLK_FANOUT_exdes.ucf CLK_FANOUT_exdes

echo 'Running map'
map -timing -pr b CLK_FANOUT_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm CLK_FANOUT_exdes -w routed.ncd routed.vhd
cd ..

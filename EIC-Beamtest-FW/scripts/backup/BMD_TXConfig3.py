...
Modifications made by Tommy Lam and Dawei Yang 
7/13/18
...
UpLim = int(2.5/0.0006105) #this ends up bing 4095, TL
LoLim = int(0.6/0.0006105) #this ends up being 982, TL
...
#recall, caliball_file contains all the scans
if os.path.isfile(caliball_file):
	os.system("sudo rm %s" %(caliball_file)) #does this remove all previous scans? 

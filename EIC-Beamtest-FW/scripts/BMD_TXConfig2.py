...
#TL: Again, I think this is something that one can set manually using BMD_sendCMD.py so we might not need this
...
th_UpLim    = 2200 # threshold scan upper limit 4095
th_LoLim    = 1800 # threshold scan lower limit 0
th_delta    = 4    # threshold increment value for course
